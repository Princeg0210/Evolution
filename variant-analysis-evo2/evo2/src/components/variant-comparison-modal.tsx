  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-white">
            ...
            <div className="space-y-6">
                  ...
                  <div>
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        ...
                        <ExternalLink className="ml-1 inline-block h-3 w-3 text-[#059669]" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="rounded-md border border-[#0A2818]/10 bg-white p-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    {/* ClinVar Assesment */}
                    <div className="rounded-md bg-[#F4FBF8]/50 p-4">
                      <h5 className="mb-2 flex items-center gap-2 text-xs font-medium text-[#0A2818]">
                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#0A2818]/10">
                          <span className="h-3 w-3 rounded-full bg-[#0A2818]"></span>
                        </span>
                        ClinVar Assessment
                      </h5>
                      <div className="mt-2">
                    ...
                    <div className="rounded-md bg-[#F4FBF8]/50 p-4">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="mt-1 h-2 w-full rounded-full bg-[#F4FBF8]/80">
                          <div
                        ...
                        <div className="mt-1 text-right text-xs text-[#0A2818]/60">
                          {Math.round(
                  ...
                  {/* Assesment Agreement */}
                  <div className="mt-4 rounded-md bg-[#F4FBF8]/20 p-3 text-xs leading-relaxed">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-[#0A2818]">
                        {comparisonVariant.classification.toLowerCase() ===
                        comparisonVariant.evo2Result.prediction.toLowerCase()
        ...
        {/* Modal footer */}
        <div className="flex justify-end border-t border-[#0A2818]/10 bg-[#F4FBF8]/30 p-4">
          <Button
            variant="outline"
            onClick={onClose}
